...
class NeuralNetwork:
    def __init__(self, layers, alpha=0.1):
        ...
        # start looping from the index of tje first layer but
    ...
    def __repr__(self):
        ...
        # architecture
        return "NeuralNetwork: %s" % ("-".join(str(l) for l in self.layers))
    ...
    def fit_partial(self, x, y):
        ...
        # feature vertor itself
        A = [np.atleast_2d(x)]

        # FEEDFORWARD:
        # loop over the layers in the network
        for layer in np.arange(len(self.W)):
            # feedforward the avtivation at the current layer by
            # taking the dot product between the activation and
            # the weight matrix -- this is called the "net input"
            # to the current layer
            net = A[layer].dot(self.W[layer])

            # computing the the "net output" is simply applying our
        ...
        # simply the error of the output layer times the deriveative
