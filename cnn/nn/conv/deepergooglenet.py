...
class DeeperGoogLeNet:
    ...
    def build(width, height, depth, classes, reg=0.0005):
        ...
        # a common pattern with all Inception modules:
        # 1. The number of 1x1 filters we learn in the first branch of the Inception module will be less
        # than or equal to the 1x1 filters in the 3x3 (second) and 5x5 (third) branches.
        # 2. The number of 1x1 filters will always be smaller than the 3x3 and 5x5 convolutions they
        # feed into.
        # 3. The number of filters we learn in the 3x3 branch will be more than the 5x5 branch which
        # helps reduce the size of the network as well as improves the speed of training/evaluation.
        # 4. The number of pool projection filters will always be smaller than the first branch of 1x1 local
        # features.
        ...
        x = DeeperGoogLeNet.inception_module(x,
                                             64,
                                             96, 128,
                                             16, 32,
                                             32,
