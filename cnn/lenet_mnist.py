...
plt.figure()
plt.plot(np.arange(20), H.history["loss"], label="train_loss")
plt.plot(np.arange(20), H.history["val_loss"], label="val_loss")
plt.plot(np.arange(20), H.history["acc"], label="train_acc")
plt.plot(np.arange(20), H.history["val_acc"], label="val_acc")
